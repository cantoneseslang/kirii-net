...
function extractDateKey(text: string): string | null {
  // HK 外送收據は DD/MM/YYYY・DD.MM.YYYY が中心（落單時間）
  const patterns: Array<{ re: RegExp; y: number; m: number; d: number }> = [
    { re: /落單時間[^\d]{0,12}(\d{1,2})[/.\\-](\d{1,2})[/.\\-](\d{4})/, y: 3, m: 2, d: 1 },
    { re: /訂單日期[^\d]{0,12}(\d{1,2})[/.\\-](\d{1,2})[/.\\-](\d{4})/, y: 3, m: 2, d: 1 },
    { re: /(\d{4})[年/.\-](\d{1,2})[月/.\-](\d{1,2})[日號]?/, y: 1, m: 2, d: 3 },
    // 16.07.2026 10:33 / 16/07/2026 10:33
