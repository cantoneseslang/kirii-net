...
const DAILY_MENUS = {
  星期一: ["冬菜榨菜蒸肉餅飯", "麻辣牛肉芝士腸飯", "蝦仁炒蛋飯", "豉椒雞球飯", "乾炒XO醬肉片烏冬", "豆腐粟米飯", "什菇時菜飯"],
  星期二: ["豉汁蒸排骨飯", "涼瓜火腩飯", "黑椒鴛鴦扒飯 (豬扒,牛扒)", "鹹蛋,火腿炒蛋飯", "豉椒牛肉炒河", "豆腐粟米飯", "什菇時菜飯"],
  星期三: ["冬菜蒸鯰魚飯", "滷水雞翼拼紅腸飯", "茄汁司華力腸豬扒飯", "四川雞柳飯", "乾炒三絲意粉", "豆腐粟米飯", "什菇時菜飯"],
  星期四: ["雜菇雲耳蒸雞球飯", "魚香茄子飯", "咖喱牛腩飯", "餐肉,腸仔,叉燒飯", "乾炒牛河", "豆腐粟米飯", "什菇時菜飯"],
  星期五: ["鹹蛋蒸肉餅飯", "蕃茄斑腩炒蛋飯", "三寶飯", "粟米雞絲火腿飯", "時菜肉片炒麵", "豆腐粟米飯", "什菇時菜飯"],
  星期六: ["梅菜蒸肉餅飯", "豆腐火腩飯", "時菜牛肉飯", "星洲炒米", "豆腐粟米飯", "什菇時菜飯"],
  星期日: ["梅菜蒸肉餅飯", "豆腐火腩飯", "時菜牛肉飯", "星洲炒米", "豆腐粟米飯", "什菇時菜飯"]
}
