...
export const translations: Record<Language, TranslationStrings> = {
  en: {
    ...
    chTypeLinearCeiling: "CH-type Linear Ceiling Series",
    cp022ClipInSystems: "CP022 Clip-in Ceiling Systems",
    suspendedCeilingSolutions: "Suspended Ceiling Solutions",
    accessHatchesBuilding: "Access Hatches and Building Accessories",
    highQualityAccessHatches: "High-quality Access Hatches",
    professionalMountingBrackets: "Professional Mounting Brackets",
    specializedFasteningSystems: "Specialized Fastening Systems",
    customBuildingSolutions: "Custom Building Solutions",
    bespokeMaterialSolutions: "Bespoke Material Solutions",
    projectSpecificCustomization: "Project-specific Customization",
    technicalSpecificationCompliance: "Technical Specification Compliance",
    // Product Catalog
    cp022ClipInAccessories: "CP022 Clip-in Ceiling Accessories",
    cp022ClipInSeries: "CP022 Clip-in Series",
    completeAccessoriesClipIn: "Complete accessories for clip-in ceiling systems",
    wideLinearCeilingAccessories: "Wide Linear Ceiling Accessories",
    linearCeilingSystems: "Linear Ceiling Systems",
    hpChCpKtAccessories: "HP-type, CH/CP-type, and KT-type accessories",
    uqTypeBaffleCeilingAccessories: "UQ-type Baffle Ceiling Accessories",
    baffleCeilingSystems: "Baffle Ceiling Systems",
    uqTypeBaffleAngleTrimming: "UQ-type baffle and angle trimming components",
  ...
  "zh-HK": {
    ...
    // Homepage Product Features
    chTypeLinearCeiling: "CH型線性天花系列",
    cp022ClipInSystems: "CP022卡扣式天花系統",
    suspendedCeilingSolutions: "懸掛天花解決方案",
    accessHatchesBuilding: "檢修口及建築配件",
    highQualityAccessHatches: "高品質檢修口",
    professionalMountingBrackets: "專業安裝支架",
    specializedFasteningSystems: "專業緊固系統",
    customBuildingSolutions: "定制建築解決方案",
    bespokeMaterialSolutions: "定制材料解決方案",
    projectSpecificCustomization: "項目專屬定制",
    technicalSpecificationCompliance: "技術規格合規",
    // Product Catalog
    cp022ClipInAccessories: "CP022卡扣式天花配件",
    cp022ClipInSeries: "CP022卡扣系列",
    completeAccessoriesClipIn: "卡扣式天花系統完整配件",
    wideLinearCeilingAccessories: "寬幅線性天花配件",
    linearCeilingSystems: "線性天花系統",
    hpChCpKtAccessories: "HP型、CH/CP型及KT型配件",
    uqTypeBaffleCeilingAccessories: "UQ型格柵天花配件",
    baffleCeilingSystems: "格柵天花系統",
    uqTypeBaffleAngleTrimming: "UQ型格柵及角飾組件",
  ...
  "zh-CN": {
    ...
    // Homepage Product Features
    chTypeLinearCeiling: "CH型线性天花系列",
    cp022ClipInSystems: "CP022卡扣式天花系统",
    suspendedCeilingSolutions: "悬挂天花解决方案",
    accessHatchesBuilding: "检修口及建筑配件",
    highQualityAccessHatches: "高品质检修口",
    professionalMountingBrackets: "专业安装支架",
    specializedFasteningSystems: "专业紧固系统",
    customBuildingSolutions: "定制建筑解决方案",
    bespokeMaterialSolutions: "定制材料解决方案",
    projectSpecificCustomization: "项目专属定制",
    technicalSpecificationCompliance: "技术规格合规",
    // Product Catalog
    cp022ClipInAccessories: "CP022卡扣式天花配件",
    cp022ClipInSeries: "CP022卡扣系列",
    completeAccessoriesClipIn: "卡扣式天花系统完整配件",
    wideLinearCeilingAccessories: "宽幅线性天花配件",
    linearCeilingSystems: "线性天花系统",
    hpChCpKtAccessories: "HP型、CH/CP型及KT型配件",
    uqTypeBaffleCeilingAccessories: "UQ型格栅天花配件",
    baffleCeilingSystems: "格栅天花系统",
    uqTypeBaffleAngleTrimming: "UQ型格栅及角饰组件",
